...
class Lista1ItemWidget extends StatelessWidget {
  Lista1ItemWidget(this.lista1ItemModelObj, {this.onTapRowoval});

  Lista1ItemModel lista1ItemModelObj;
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Obx(
                              () => Text(
                                lista1ItemModelObj.jenningschampliTxt.value,
                                overflow: TextOverflow.ellipsis,
                                textAlign: TextAlign.left,
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Obx(
                            () => Text(
                              lista1ItemModelObj.jenningschampliTwoTxt.value,
                              overflow: TextOverflow.ellipsis,
                              textAlign: TextAlign.left,
                              style: AppStyle.txtOverpassBold16,
                            ),
